                    ...
                    <div className="aspect-square relative bg-muted overflow-hidden">
                      ...
                      {isUnavailable && (
                        <div className="absolute inset-0 bg-background/80 flex items-center justify-center">
                          <span className="px-4 py-2 bg-destructive/10 text-destructive rounded-full font-bold text-sm">
                            🔴 SOLD OUT
                          </span>
                        </div>
                      )}
                      ...
                      {/* Low stock badge */}
                      {!isUnavailable && product.stock !== null && product.stock !== undefined && product.stock <= 3 && product.stock > 0 && (
                        <div className="absolute top-3 left-3">
                          <span className="px-2.5 py-1 bg-amber-500 text-white rounded-full font-bold text-xs shadow-lg animate-pulse">
